package com.huishan.enjoytravel.widget.splitedittext;
...
public class SplitEditTextView extends AppCompatEditText{
    ...
    private void initAttrs(Context c, AttributeSet attrs) {
        ...
        mBoxColor = array.getColor(R.styleable.SplitEditTextView_boxColor, Color.WHITE);
        isBoxFill = array.getBoolean(R.styleable.SplitEditTextView_isBoxFill, false);
    ...
    private void init() {
        ...
        if (isBoxFill) {
            ...
            mPaintBorder.setColor(mBoxColor);
        } else {
