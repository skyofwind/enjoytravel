...
@HiltViewModel
class InspectionWorkOrderViewModel @Inject constructor(private val bikeRepository: Repository) :
    ViewModel() {
    var entityList = ArrayList<ItemInspectionWorkOrderEntity>()
    ...
    /**数据传递没写，自己选择方式实现吧*/
    fun onDetail(view: View, item: ItemInspectionWorkOrderEntity) {
        view.findNavController().navigate(R.id.inspection_work_order_details_fragment_dest)
    }
