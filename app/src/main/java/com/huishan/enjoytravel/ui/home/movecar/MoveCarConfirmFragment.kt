...
import com.huishan.enjoytravel.databinding.FragmentMoveCarConfirmBinding
import com.huishan.enjoytravel.ui.BaseFragment
import com.huishan.enjoytravel.ui.MyBindingAdapter
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class MoveCarConfirmFragment: BaseFragment() {

    private var viewDataBinding: FragmentMoveCarConfirmBinding? = null
    ...
    override fun onCreateView(
        ...
        viewDataBinding = FragmentMoveCarConfirmBinding.bind(view).apply {
    ...
    override fun getLayoutResId(): Int {
        return R.layout.fragment_move_car_confirm
    }
    ...
    private fun initRecyclerView() {
        if (adapter == null) {
            adapter = MyBindingAdapter(requireContext(), R.layout.item_move_car_confirm, viewModel, viewModel.confirmList)
