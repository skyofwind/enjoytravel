...
/**车辆维修工单列表*/
@AndroidEntryPoint
class RepairWorkOrderFragment: BaseFragment() {

    private val viewModel by viewModels<RepairWorkOrderViewModel>()
    private var viewDataBinding: FragmentRepairWorkOrderBinding? = null
    var adapter: MyBindingAdapter<ItemRepairWorkOrderEntity>? = null
    ...
    override fun onCreateView(
        ...
        viewDataBinding = FragmentRepairWorkOrderBinding.bind(view).apply {
            viewmodel = viewModel
    ...
    override fun getLayoutResId(): Int {
        return R.layout.fragment_repair_work_order
    }
    ...
    fun initList() {
        if (adapter == null) {
            adapter = MyBindingAdapter(requireContext(), R.layout.item_repair_work_order, viewModel, viewModel.list)
