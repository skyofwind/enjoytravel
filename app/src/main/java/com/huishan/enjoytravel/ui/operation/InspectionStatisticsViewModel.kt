...
@HiltViewModel
class InspectionStatisticsViewModel @Inject constructor(private val bikeRepository: Repository) : ViewModel() {

    var entityList = ArrayList<ItemInspectionStatisticsEntity>()
